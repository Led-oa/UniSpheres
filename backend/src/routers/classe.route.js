...
router.get("/teacher", ClasseController.getClasseByTeacher);
...
router.get("/:id/students", ClasseController.getStudentFromClass);
router.get("/:id/teachers", ClasseController.getTeacherOfClass);
