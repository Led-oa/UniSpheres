...
const menuItems = [
  { name: "TableauDeBordsAdmin", label: "Dashboard" },
  { name: "GestionUtilisateursAdmin", label: "Utilisateurs" },
  { name: "GestionAnnoncesAdmin", label: "Annonces" },
  { name: "GestionCoursAdmin", label: "Cours" },
  { name: "GestionAcademiquesAdmin", label: "Gestion Classes" },
  { name: "ProfileAdmin", label: "Profile" },
];
    ...
    <header class="bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow">
      ...
      >
        ...
        <router-link to="/" class="flex items-center space-x-2">
          ...
          <span class="text-xl font-bold">UniSphere Admin</span>
        </router-link>
